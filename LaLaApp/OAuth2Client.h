...
@interface OAuth2Client : NSObject  <NSCoding>{
...
typedef enum OAuth2ResponseParameters {
    ...
    kOAuth2ResponseParamRefreshExpiresIn
} OAuth2ResponseParameter;

#define OAuth2ResponseParameterArray @"access_token", @"refresh_token", @"token_type", @"expires_in", @"code", @"state", @"error", @"error_description", @"error_uri", @"id_token", @"refresh_expires_in", nil


@property (nonatomic, retain) NSString *baseUrl;
@property (nonatomic, retain) NSString *authorizationEndpoint;
@property (nonatomic, retain) NSString *tokenEndpoint;
@property (nonatomic, retain) NSString *endSessionEndpoint;
